(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.steve, 500, 300, 5, 0.9);
        collectable.create(type.steve, 160, 350, 4, 1);
        collectable.create(type.steve, 650, 500, 6, 2);
      //collectable.create(type.steve, 200)
        //collectable.create()
